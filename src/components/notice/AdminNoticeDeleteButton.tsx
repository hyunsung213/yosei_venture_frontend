...
import { deleteNotice } from "@/api/delete";
import { useRouter } from "next/navigation";
import { useState } from "react";

interface AdminNoticeDeleteButtonProps {
  noticeId: string;
  type: 'community' | 'wave';
}

export default function AdminNoticeDeleteButton({ noticeId, type }: AdminNoticeDeleteButtonProps) {
  const { role } = useAuth();

          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 overflow-y-auto space-y-5 flex-1">
              <div>
                ...
                <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-yonsei-blue focus:border-transparent outline-none transition" placeholder="공지사항 제목 입력" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-1">해쉬태그</label>
                <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-yonsei-blue focus:border-transparent outline-none transition" placeholder="#해쉬태그 #입력" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-1">본문</label>
                <textarea rows={8} className="w-full border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-yonsei-blue focus:border-transparent outline-none transition resize-none" placeholder="본문 내용을 입력하세요..."></textarea>
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-1">관련 파일 첨부</label>
                <input type="file" multiple className="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200" />
              </div>
            </div>
            ...
            <div className="p-6 border-t border-gray-100 flex justify-end gap-3 bg-white">
              ...
              <button onClick={() => setIsModalOpen(false)} className="px-5 py-2.5 rounded-lg bg-yonsei-blue text-white font-bold hover:bg-blue-800 transition shadow-md">
                생성하기
              </button>
            </div>
          </div>
